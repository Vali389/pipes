// Full list of countries with dial codes and ISO codes for flags (E.164)
// Normalized: code = dial_code without spaces for form value
export const countryCodes = [
  ...
  { code: '+1340', country: 'U.S. Virgin Islands', iso: 'VI' },
...
// Build ISO lookup from dial code (first occurrence wins for shared codes like +1)
export const getCountryISO = (countryCode) => {
  const normalized = (countryCode || '').replace(/\s/g, '')
  const found = countryCodes.find((c) => c.code === normalized || c.code.replace(/\s/g, '') === normalized)
